...
public class ProfileManager {
    ...
    private int userId; // The ID of the user (fetched from the db)
    ...
    /**
     * Deletes a profile by name. If the profile is found and deleted, the profile file is updated accordingly.
     * 
     * @param profileName The name of the profile to be deleted.
     * @return true if the profile is deleted, false if the profile is not found.
     */
    public boolean deleteProfile(String profileName) {
        // Creates a stream of profiles.
        Optional<UserProfile> profileToRemove = profiles.stream()
        		//The filter operation filters for the profileName by matching with the profile the user wants to delete.
                .filter(profile -> profile.getProfileName().equals(profileName)) 
                //This is a terminal operation that returns an Optional<UserProfile> containing the first matching profile (if found). 
